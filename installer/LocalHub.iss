...
; NOT: Setup.exe Inno Setup build sonrasi publish-release.ps1 tarafindan
; signtool ile imzalanir (Inno Setup SignTool param. PowerShell escape
; sorununa takiliyor, dolayisiyla harici imzalama daha guvenilir).
